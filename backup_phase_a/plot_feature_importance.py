...
def main():
    ...
    df_all.to_csv('results/top_features.csv', index=False)
    print("Saved: results/top_features.csv")
    ...
    fig.suptitle('Feature Importance - HalluciGuard Logistic Regression', fontsize=16, fontweight='bold', y=1.02)
    plt.tight_layout()
