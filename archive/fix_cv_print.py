...
content = content.replace("print(f\"\\nSaved: {os.path.join(RESULTS_DIR, 'cross_validation_results.csv')}\")", 
                         'print(f"\\nSaved: {os.path.join(RESULTS_DIR, \"metrics/cross_validation_results.csv\")}")')
content = content.replace("print(f\"Saved: {os.path.join(RESULTS_DIR, 'cross_validation_summary.json')}\")", 
                         'print(f"Saved: {os.path.join(RESULTS_DIR, \"metrics/cross_validation_summary.json\")}")')
content = content.replace("print(f\"Saved: {os.path.join(RESULTS_DIR, 'cross_validation_summary.txt')}\")", 
